...
* Any other Triva-related forums
...
5. Circumstances surrounding the event
6. Any additional relevant information
7. Links to public records (if applicable)

### Confidentiality

All reports will be kept confidential. We will:

* Not disclose the reporter's identity without consent
* Keep reporter information secure
* Share details only with enforcement team
* Provide updates to the reporter
...
If you believe you have been unjustly sanctioned:

1. Email contact@trivajs.com within 14 days
2. Explain why you believe the decision was incorrect
3. Provide any relevant information
4. Decision will be reviewed by different team members
5. Final decision communicated within 30 days
...
**Do:**
* Read the Contributing Guide before submitting
...
**Do:**
* Respond to issues and PRs promptly (within 7 days)
...
* People from all geographic locations
...
Try to resolve directly with the person involved.

### Step 2: Mediation
Request mediation from a community leader.

### Step 3: Formal Report
File a formal report if unresolved.

### Step 4: Enforcement
Community leaders will take appropriate action.
...
* **Hall of Fame** - Outstanding community members
* **Special Recognition** - Unique contributions acknowledged
...
* **Email:** contact@trivajs.com
* **GitHub Discussion:** [Discussions](https://github.com/trivajs/triva/discussions)
...
This Code of Conduct may be updated. Material changes will be announced through:
